                        ...
                        <div class="card">
                            ...
                            <div class="flex-row">
                                ...
                                <div class="p-10 bg-info col-md-12 text-center">
                                    ...
                                    <h3 class="text-white box m-b-0"><i class="mdi mdi-food-fork-drink"></i></h3></div>

                                <div class="align-self-center pt-3 col-md-12 text-center">

                                    <h3 class="m-b-0 text-info" id="restaurant_count">0</h3>

                                    <h5 class="text-muted m-b-0">{{trans('lang.restaurant_plural')}}</h5>

                                    <a href="{!! route('restaurants') !!}" class="small-box-footer">{{trans('lang.dashboard_more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                        ...
                        <div class="card">
                            ...
                            <div class="flex-row">
                                ...
                                <div class="align-self-center pt-3 col-md-12 text-center">
                                    ...
                                    <a href="{!! route('users') !!}" class="small-box-footer">{{trans('lang.dashboard_more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
 ...
 function buildDriverHTML(snapshots){
    ...
    function buildOrderHTML(snapshots){
        ...
        snapshots.docs.forEach((listval) => {
                ...
                var restaurantroute = '<?php echo route("restaurants.view",":id");?>';
                ...
                html=html+'<td data-url="'+restaurantroute+'" class="redirecttopage">'+val.vendor.title+'</td>';
