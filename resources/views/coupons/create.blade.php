...
<div class="page-wrapper">
	<div class="row page-titles">
        ...
        <?php if($id != ''){?>
          <li class="breadcrumb-item"><a href= "{{route('restaurants.coupons',$id)}}" >{{trans('lang.coupon_plural')}}</a></li>
        <?php }else{ ?>
  ...
  $(function() {
   ...
   /*   }else if(resturant_id == ''){
       ...
       //   console.log('done'+resturant_id+' '+expiresAt);
           ...
           database.collection('coupons').doc(id).set({'code':code,'description':description,'discount':discount,'expiresAt':expiresAt,'isEnabled':isEnabled,'id':id,'discountType':discountType,'image':photo_coupon,'resturant_id':resturant_id}).then(function(result) {
              if (resturant) {
