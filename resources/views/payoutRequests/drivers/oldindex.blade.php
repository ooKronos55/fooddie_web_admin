...
<script>
    ...
    var start = null;
    var user_number = [];
    var refData = database.collection('driver_payouts').where('status', '==', 'pending');
    ...
    function buildHTML(snapshots) {
        ...
        alldata.forEach((listval) => {
            ...
            html = html + '<td class="action-btn"><a id="' + val.id + '" name="driver_check" data-auth="' + val.driverID.id + '" href="javascript:void(0)"><i class="fa fa-check" ></i></a><a id="' + val.id + '" name="book-table-dismiss" data-auth="' + val.driverID.id + '" href="javascript:void(0)"><i class="fa fa-close" ></i></a></td>';
    ...
    $(document).on("click", "a[name='driver_check']", function (e) {
        ...
        database.collection('driver_payouts').doc(id).update({'status': 'success'}).then(function (result) {
